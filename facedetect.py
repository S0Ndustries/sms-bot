...
def detect(imgURL):
	...
	#print racestring
	masterstring = "Ayye ! I am not just some stupid bot who can send SMSs. I can do way more. Here's an example of my supreme intelligence."+genderstring+agestring+specsstring#+racestring
	print masterstring
	return masterstring


if __name__ == '__main__':
    detect("http://www.faceplusplus.com/wp-content/themes/faceplusplus/assets/img/demo/1.jpg")

# ADD LOGIC FOR MANY FACES IN THE IMAGE AND NO FACES. Check the parameters being passed in the GET request from the API   
# requests library to be added to the requirements file 